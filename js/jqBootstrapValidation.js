    ...
    var defaults = {
                ...
                $(uniqueForms).bind("submit", function(e) {
                    ...
                    if (warningsFound) {
                        ...
                        if ($.isFunction(settings.options.submitError)) {
                            settings.options.submitError($form, e, $inputs.jqBootstrapValidation("collectErrors", !0))
                        }
                    } else {
                    ...
                    $.each(validatorNames, function(i, el) {
                        ...
                        $.each(settings.validatorTypes, function(validatorType, validatorTemplate) {
                            ...
                            if (!foundValidator && $this.data("validation" + el + formatValidatorName(validatorTemplate.name)) !== undefined) {
                                validators[validatorType].push($.extend(!0, {
        ...
        validatorTypes: {
            ...
            ajax: {
                ...
                validate: function($this, value, validator) {
                    if ("" + validator.lastValue === "" + value && validator.lastFinished === !0) {
                        return validator.lastValid === !1
                    }
                    if (validator.lastFinished === !0) {
                        validator.lastValue = value;
                        validator.lastValid = !0;
